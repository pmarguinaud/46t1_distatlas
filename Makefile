...
src/local/atlas/io/atlas-fmt-netcdf.o: src/local/atlas/io/atlas-fmt-netcdf.F90 src/local/atlas/io/atlas-fmt.o src/local/ifsaux/module/parkind1.o
	cd src/local/atlas/io && $(F90) -c -I../include -I. -I../../ifsaux/module -o atlas-fmt-netcdf.o atlas-fmt-netcdf.F90
...
pgd: src/local/atlas/programs/atlas-pgd-gmme.o src/local/atlas/programs/atlas-helper.o src/local/atlas/interpolation/interpolation4.o src/local/atlas/interpolation/interpolationA.o src/local/atlas/fortran/interpolationA_mod.o src/local/atlas/fortran/interpolation4_mod.o src/local/atlas/fortran/gradient_mod.o src/local/atlas/gradient/gradient.o src/local/atlas/surfex/atlas-compute-aos.o src/local/atlas/surfex/atlas-compute-sso.o src/local/atlas/surfex/atlas-prep-impl.o src/local/atlas/surfex/atlas-pgd-impl.o src/local/atlas/surfex/readcovers_mod.o src/local/atlas/surfex/atlas-compute-covers.o src/local/atlas/io/atlas-fmt-netcdf.o src/local/atlas/io/atlas-io-gathscat.o src/local/atlas/io/atlas-io-dh.o src/local/atlas/io/atlas-fmt.o src/local/atlas/io/atlas-io.o src/local/ifsaux/module/parkind1.o src/local/ifsaux/module/xrd_getoptions.o src/local/ifsaux/module/xrd_unix_env.o src/local/ifsaux/fi_libc/fi_libc.o src/local/ifsaux/support/iswap8.o
	$(LD) -o pgd src/local/atlas/programs/atlas-pgd-gmme.o src/local/atlas/programs/atlas-helper.o src/local/atlas/interpolation/interpolation4.o src/local/atlas/interpolation/interpolationA.o src/local/atlas/fortran/interpolationA_mod.o src/local/atlas/fortran/interpolation4_mod.o src/local/atlas/fortran/gradient_mod.o src/local/atlas/gradient/gradient.o src/local/atlas/surfex/atlas-compute-aos.o src/local/atlas/surfex/atlas-compute-sso.o src/local/atlas/surfex/atlas-prep-impl.o src/local/atlas/surfex/atlas-pgd-impl.o src/local/atlas/surfex/readcovers_mod.o src/local/atlas/surfex/atlas-compute-covers.o src/local/atlas/io/atlas-fmt-netcdf.o src/local/atlas/io/atlas-io-gathscat.o src/local/atlas/io/atlas-io-dh.o src/local/atlas/io/atlas-fmt.o src/local/atlas/io/atlas-io.o src/local/ifsaux/module/parkind1.o src/local/ifsaux/module/xrd_getoptions.o src/local/ifsaux/module/xrd_unix_env.o src/local/ifsaux/fi_libc/fi_libc.o src/local/ifsaux/support/iswap8.o $(LIBS)

clean: 
	\rm -f src/local/atlas/programs/atlas-pgd-gmme.o src/local/atlas/programs/atlas-helper.o src/local/atlas/interpolation/interpolation4.o src/local/atlas/interpolation/interpolationA.o src/local/atlas/fortran/interpolationA_mod.o src/local/atlas/fortran/interpolation4_mod.o src/local/atlas/fortran/gradient_mod.o src/local/atlas/gradient/gradient.o src/local/atlas/surfex/atlas-compute-aos.o src/local/atlas/surfex/atlas-compute-sso.o src/local/atlas/surfex/atlas-prep-impl.o src/local/atlas/surfex/atlas-pgd-impl.o src/local/atlas/surfex/readcovers_mod.o src/local/atlas/surfex/atlas-compute-covers.o src/local/atlas/io/atlas-fmt-netcdf.o src/local/atlas/io/atlas-io-gathscat.o src/local/atlas/io/atlas-io-dh.o src/local/atlas/io/atlas-fmt.o src/local/atlas/io/atlas-io.o src/local/ifsaux/module/parkind1.o src/local/ifsaux/module/xrd_getoptions.o src/local/ifsaux/module/xrd_unix_env.o src/local/ifsaux/fi_libc/fi_libc.o src/local/ifsaux/support/iswap8.o pgd
