...
TYPE, EXTENDS (ATLAS_FMT_t) :: ATLAS_FMT_NULL_t
CONTAINS
...
END TYPE ATLAS_FMT_NULL_t

PRIVATE

PUBLIC :: ATLAS_FMT_NULL_t

CONTAINS

TYPE (ATLAS_STRUCTUREDGRID) FUNCTION GRID (THIS, CDFILE)
USE ATLAS_MODULE
CLASS (ATLAS_FMT_NULL_t), INTENT (IN) :: THIS
...
USE ATLAS_MODULE
CLASS (ATLAS_FMT_NULL_t),      INTENT (INOUT) :: THIS
CHARACTER (LEN=*),             INTENT (IN)    :: CDFILE
