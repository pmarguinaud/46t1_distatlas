...
999 CONTINUE
  ...
  CALL ATLAS_ABORT ('ATLAS_FMT_OZONE:READLLABC: ERROR WHILE READING '//TRIM (CDFILE))
...
ELSEIF (LCMPM (CDNAME, 'c', IMONTH)) THEN
  IND = 5
ELSE
  CALL ATLAS_ABORT ('ATLAS_FMT_OZONE:READ: UNEXPECTED FIELD '//TRIM (CDNAME))
ENDIF
...
CALL ATLAS_ABORT ('ATLAS_FMT_OZONE:WRITE NOT IMPLEMENTED')
