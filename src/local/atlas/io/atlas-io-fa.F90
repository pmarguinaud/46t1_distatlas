...
TYPE, EXTENDS (ATLAS_IO_t) :: ATLAS_IO_FA_t
CONTAINS
...
PRIVATE
PUBLIC :: ATLAS_IO_FA_t, ISMGLO, ISMLAM, ISLTLN

CONTAINS

TYPE (ATLAS_STRUCTUREDGRID) FUNCTION GRID (THIS, CDFILE) RESULT (YLGRID)
CLASS (ATLAS_IO_FA_t), INTENT (IN) :: THIS
...
YLTRAC_GA = ATLAS_TRACE (__FILE__, __LINE__, "ATLAS_IO_FA:WRITE:GATHER")
CALL YDSTCO%GATHER (YDFLST, YLFLSG)
CALL YLTRAC_GA%FINAL ()

YLTRAC_WR = ATLAS_TRACE (__FILE__, __LINE__, "ATLAS_IO_FA:WRITE:WRITE")
DO JFLD = 1, INFLD
