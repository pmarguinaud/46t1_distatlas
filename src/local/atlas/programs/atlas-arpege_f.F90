...
USE GRADIENT_MOD
USE ATLAS_ARPEGE_MODULE, ONLY : WFA, GFA, ISMGLO, ISMLAM, ISLTLN
...
IF (LLROTATE) THEN
  CALL WFA ('UV1.fa', YLGRID1, YLFSSC1, YLFLDS1UV)
ENDIF
...
IF (LLROTATE) THEN
  CALL WFA ('UV1R.fa', YLGRID1, YLFSSC1, YLFLDS1UV)
ENDIF
...
IF (LLWRITE1) THEN
  ...
  IF (LLGRADIENT) THEN
    CALL WFA ('XYZ1GT.fa', YLGRID1, YLFSSC1, YLFLDS1GT)
    CALL WFA ('XYZ1GC.fa', YLGRID1, YLFSSC1, YLFLDS1GC)
  ENDIF
ENDIF
IF (LLWRITE2) THEN
...
IF (LLHALFDIFF) THEN
  CALL WFA ('HALFDIFF1.fa', YLGRID1, YLFSSC1, YLFLDS1HD)
ENDIF
...
TYPE (ATLAS_METADATA) :: YLMETUX
TYPE (ATLAS_METADATA) :: YLMETUY
TYPE (ATLAS_METADATA) :: YLMETVX
TYPE (ATLAS_METADATA) :: YLMETVY

YDFLDS = ATLAS_FIELDSET ()

YLUX = ATLAS_FIELD (NAME="UX", KIND=JPRB, SHAPE=[YDFSSC%SIZE ()])
YLUY = ATLAS_FIELD (NAME="UY", KIND=JPRB, SHAPE=[YDFSSC%SIZE ()])
YLVX = ATLAS_FIELD (NAME="VX", KIND=JPRB, SHAPE=[YDFSSC%SIZE ()])
YLVY = ATLAS_FIELD (NAME="VY", KIND=JPRB, SHAPE=[YDFSSC%SIZE ()])

YLMETUX = YLUX%METADATA ()
YLMETUY = YLUY%METADATA ()
YLMETVX = YLVX%METADATA ()
YLMETVY = YLVY%METADATA ()

CALL YLMETUX%SET ("INIVAU", 0); CALL YLMETUX%SET ("CLPREF", "SURF"); CALL YLMETUX%SET ("CLSUFF", "UX")
CALL YLMETUY%SET ("INIVAU", 0); CALL YLMETUY%SET ("CLPREF", "SURF"); CALL YLMETUY%SET ("CLSUFF", "UY")
CALL YLMETVX%SET ("INIVAU", 0); CALL YLMETVX%SET ("CLPREF", "SURF"); CALL YLMETVX%SET ("CLSUFF", "VX")
CALL YLMETVY%SET ("INIVAU", 0); CALL YLMETVY%SET ("CLPREF", "SURF"); CALL YLMETVY%SET ("CLSUFF", "VY")
...
YLX = ATLAS_FIELD (NAME="X", KIND=JPRB, SHAPE=[YDFSSC%SIZE ()])
YLY = ATLAS_FIELD (NAME="Y", KIND=JPRB, SHAPE=[YDFSSC%SIZE ()])
YLZ = ATLAS_FIELD (NAME="Z", KIND=JPRB, SHAPE=[YDFSSC%SIZE ()])
...
INTEGER (KIND=JPIM) :: IX, IY, JLOC
TYPE (ATLAS_METADATA) :: YLMETX_DX, YLMETY_DX, YLMETZ_DX
TYPE (ATLAS_METADATA) :: YLMETX_DY, YLMETY_DY, YLMETZ_DY

YDFLDS = ATLAS_FIELDSET ()

YLX_DX = ATLAS_FIELD (NAME="X.DX", KIND=JPRB, SHAPE=[YDFSSC%SIZE ()])
YLY_DX = ATLAS_FIELD (NAME="Y.DX", KIND=JPRB, SHAPE=[YDFSSC%SIZE ()])
YLZ_DX = ATLAS_FIELD (NAME="Z.DX", KIND=JPRB, SHAPE=[YDFSSC%SIZE ()])
YLX_DY = ATLAS_FIELD (NAME="X.DY", KIND=JPRB, SHAPE=[YDFSSC%SIZE ()])
YLY_DY = ATLAS_FIELD (NAME="Y.DY", KIND=JPRB, SHAPE=[YDFSSC%SIZE ()])
YLZ_DY = ATLAS_FIELD (NAME="Z.DY", KIND=JPRB, SHAPE=[YDFSSC%SIZE ()])

YLMETX_DX = YLX_DX%METADATA ()
YLMETY_DX = YLY_DX%METADATA ()
YLMETZ_DX = YLZ_DX%METADATA ()
YLMETX_DY = YLX_DY%METADATA ()
YLMETY_DY = YLY_DY%METADATA ()
YLMETZ_DY = YLZ_DY%METADATA ()

CALL YLMETX_DX%SET ("INIVAU", 0); CALL YLMETX_DX%SET ("CLPREF", "SURF"); CALL YLMETX_DX%SET ("CLSUFF", "X.DX")
CALL YLMETY_DX%SET ("INIVAU", 0); CALL YLMETY_DX%SET ("CLPREF", "SURF"); CALL YLMETY_DX%SET ("CLSUFF", "Y.DX")
CALL YLMETZ_DX%SET ("INIVAU", 0); CALL YLMETZ_DX%SET ("CLPREF", "SURF"); CALL YLMETZ_DX%SET ("CLSUFF", "Z.DX")
CALL YLMETX_DY%SET ("INIVAU", 0); CALL YLMETX_DY%SET ("CLPREF", "SURF"); CALL YLMETX_DY%SET ("CLSUFF", "X.DY")
CALL YLMETY_DY%SET ("INIVAU", 0); CALL YLMETY_DY%SET ("CLPREF", "SURF"); CALL YLMETY_DY%SET ("CLSUFF", "Y.DY")
CALL YLMETZ_DY%SET ("INIVAU", 0); CALL YLMETZ_DY%SET ("CLPREF", "SURF"); CALL YLMETZ_DY%SET ("CLSUFF", "Z.DY")
...
CALL YLMETX_DX%FINAL ()
CALL YLMETY_DX%FINAL ()
CALL YLMETZ_DX%FINAL ()
CALL YLMETX_DY%FINAL ()
CALL YLMETY_DY%FINAL ()
CALL YLMETZ_DY%FINAL ()
