...
LOGICAL :: LLWRITE1, LLWRITE2, LLINTERP4, LLINTERPA, LLLIGHT1, LLLIGHT2, LLGRADIENT
...
IF (LLGRADIENT) THEN
  CALL GETXYZGRAD (YLFLDS1GT,  YLFSSC1, YLGRID1)
ENDIF
...
SUBROUTINE GETXYZGRAD (YDFLDS, YDFSSC, YDGRID)
