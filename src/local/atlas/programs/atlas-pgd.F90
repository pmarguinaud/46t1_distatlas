...
BLOCK
  ...
  REAL (KIND=JPRB), POINTER, DIMENSION (:) :: ZOROG1INT4, ZOROG1, ZOROG2, &
  ...
  YLOROG1INT4  = YLINTE4%INTERPOLATE (YLOROG2)
...
!$OMP END WORKSHARE
  ...
  YLAOSIP1 = NEWFLD (YLFSSC1, "SFX.AOSIP", ZUNDEF); CALL YLAOSIP1%DATA (ZAOSIP1) 
  YLAOSIM1 = NEWFLD (YLFSSC1, "SFX.AOSIM", ZUNDEF); CALL YLAOSIM1%DATA (ZAOSIM1) 
  YLAOSJP1 = NEWFLD (YLFSSC1, "SFX.AOSJP", ZUNDEF); CALL YLAOSJP1%DATA (ZAOSJP1) 
  YLAOSJM1 = NEWFLD (YLFSSC1, "SFX.AOSJM", ZUNDEF); CALL YLAOSJM1%DATA (ZAOSJM1) 

!$OMP WORKSHARE
  WHERE (ZOROG1 /= ZUNDEF)
    ZAOSIP1 = + MAX (0._JPRB, ZOROG1IP)
    ZAOSIM1 = - MIN (0._JPRB, ZOROG1IM)   
    ZAOSJP1 = + MAX (0._JPRB, ZOROG1JP)
    ZAOSJM1 = - MIN (0._JPRB, ZOROG1JM)
  ELSEWHERE
    ZAOSIP1 = ZUNDEF
    ZAOSIM1 = ZUNDEF
    ZAOSJP1 = ZUNDEF
...
!$OMP END WORKSHARE
  ...
  YLHO2IP1 = NEWFLD (YLFSSC1, "SFX.HO2IP", ZUNDEF); CALL YLHO2IP1%DATA (ZHO2IP1) 
  YLHO2IM1 = NEWFLD (YLFSSC1, "SFX.HO2IM", ZUNDEF); CALL YLHO2IM1%DATA (ZHO2IM1) 
  YLHO2JP1 = NEWFLD (YLFSSC1, "SFX.HO2JP", ZUNDEF); CALL YLHO2JP1%DATA (ZHO2JP1) 
  YLHO2JM1 = NEWFLD (YLFSSC1, "SFX.HO2JM", ZUNDEF); CALL YLHO2JM1%DATA (ZHO2JM1) 

!$OMP WORKSHARE
  WHERE ((ZOROG1 /= ZUNDEF) .AND. (ZOROG1IP > 0._JPRB))
    ZHO2IP1 = + ZOROG1IP * 0.5_JPRB      
  ELSEWHERE
    ZHO2IP1 = ZUNDEF
  ENDWHERE
!$OMP END WORKSHARE
...
!$OMP WORKSHARE
  WHERE ((ZOROG1 /= ZUNDEF) .AND. (ZOROG1IM < 0._JPRB))
    ZHO2IM1 = - ZOROG1IM * 0.5_JPRB       
  ELSEWHERE
    ZHO2IM1 = ZUNDEF
  ENDWHERE
!$OMP END WORKSHARE
...
!$OMP WORKSHARE
  WHERE ((ZOROG1 /= ZUNDEF) .AND. (ZOROG1JP > 0._JPRB))
    ZHO2JP1 = + ZOROG1JP * 0.5_JPRB       
  ELSEWHERE
    ZHO2JP1 = ZUNDEF
  ENDWHERE
!$OMP END WORKSHARE
...
!$OMP WORKSHARE
  WHERE ((ZOROG1 /= ZUNDEF) .AND. (ZOROG1JM < 0._JPRB))
    ZHO2JM1 = - ZOROG1JM * 0.5_JPRB      
  ELSEWHERE
    ZHO2JM1 = ZUNDEF
  ENDWHERE
!$OMP END WORKSHARE
