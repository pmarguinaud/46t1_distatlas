...
CALL INS1 (JZS     , DIR (CLDATA (JOROG_DAT), YLHDRS (JOROG_DAT), YLFSSC1, YLGRID1, YLDIST1))
CALL INS1 (JCLAY   , DIR (CLDATA (JCLAY_DAT), YLHDRS (JCLAY_DAT), YLFSSC1, YLGRID1, YLDIST1, 0.01_JPRB))
CALL INS1 (JSAND   , DIR (CLDATA (JSAND_DAT), YLHDRS (JSAND_DAT), YLFSSC1, YLGRID1, YLDIST1, 0.01_JPRB))
CALL INS1 (JCOVER+1, DIR (CLDATA (JCOVR_DAT), YLHDRS (JCOVR_DAT), YLFSSC1, YLGRID1, YLDIST1))
...
CALL WFA ('PGD1.fa', YLGRID1, YLFSSC1, YLFLDS1)
