...
LOGICAL, ALLOCATABLE :: OSSO (:), OSSO_ANIS (:)
REAL (KIND=JPRB), ALLOCATABLE :: ZK (:), ZL (:), ZM (:)


TYPE (ATLAS_FIELDSET) :: YLFSGR1
TYPE (ATLAS_FIELD) :: YLOROG1DX, YLOROG1DY
TYPE (ATLAS_STRUCTUREDGRID) :: YLGRID2
REAL (KIND=JPRB), POINTER :: ZOROG1DX (:), ZOROG1DY (:), ZOROG1 (:), ZOROG2 (:)
...
ALLOCATE (OSSO (YDFSSC2%SIZE ()), OSSO_ANIS (YDFSSC2%SIZE ()))
ALLOCATE (ZK (YDFSSC2%SIZE ()), ZL (YDFSSC2%SIZE ()), ZM (YDFSSC2%SIZE ()))
