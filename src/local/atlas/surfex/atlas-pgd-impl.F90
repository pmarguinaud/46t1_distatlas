...
BLOCK
  ...
  CHARACTER (LEN=32) :: CLNEW

  CALL GETENV ('CLNEW', CLNEW)

  IF (TRIM (CLNEW) /= '1') THEN
  ...
  YLFLDS2SSO = ATLAS_COMPUTE_SSO2 (YLFSSC1, YLFSSC2, YLFL1 (JZS), YLINTEA, LLOPENMP, LLROTATE) 
