...
!#OMP                    & ZCOSLAT2, ZSINLAT2, ZCOSLON2, ZSINLON2, ZXYZ2) 
  DO JLOC2 = 1, IGPTOT2
  LLDBG = .FALSE. .AND. (MYPROC == 1) .AND. (JLOC2 == 12)
...
! DO JJ = 1, SIZE (IGLO1)
!   WRITE (*, '(" GREP ",I8," > ",I8,I8)') JJ, IPRC1 (JJ), IGLO1 (JJ)
! ENDDO
...
! DO IPROC = 1, INPROC
!   WRITE (*, '(" GREP RECV ",I8," > ",I8)') IPROC, IRECVCNT (IPROC)
! ENDDO
! 
! DO IPROC = 1, INPROC
!   WRITE (*, '(" GREP SEND ",I8," > ",I8)') IPROC, ISENDCNT (IPROC)
! ENDDO
